    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{Request::is('aplikasi')?'active':''}}"><a href="{{url('aplikasi')}}"><i class="fa fa-map"></i> <span>Aplikasi</span></a></li>
          <li class="{{Request::is('Video')?'active':''}}"><a href="{{url('video')}}"><i class="fa fa-tags"></i> <span>Videos</span></a></li>
